"""
This is a copy of the CLTK scanner with one change:  the logger is disabled.
While this does not fix any true errors with the scanner, it prevents all of
its warnings from being automatically printed, greatly enhancing the readability
of the output.
"""
